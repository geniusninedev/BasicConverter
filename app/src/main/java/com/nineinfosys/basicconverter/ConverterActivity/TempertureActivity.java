...
import com.nineinfosys.basicconverter.ConverterActivityList.ConversionTempListActivity;
...
public class TempertureActivity extends AppCompatActivity implements View.OnClickListener,TextWatcher {
    ...
    TemperatureConverter.ConversionResults item;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(TempertureActivity.this, getString(R.string.ads_app_id));
        ...
        listtempFirstfrom.add("Celsius - °C");
        listtempFirstfrom.add("Fahrenheit - °F");
        listtempFirstfrom.add("Kelvin - °K");


        listFirsttempTo.add("Celsius - °C");
        listFirsttempTo.add("Fahrenheit - °F");
        listFirsttempTo.add("Kelvin - °K");

        // Creating adapter for spinner
        ArrayAdapter<String> Adapter = new ArrayAdapter<String>(TempertureActivity.this, android.R.layout.simple_spinner_item, listtempFirstfrom);
        ArrayAdapter<String> AdapterTempTo = new ArrayAdapter<String>(TempertureActivity.this, android.R.layout.simple_spinner_item, listFirsttempTo);
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                switch (stringSwitchSate) {
                    ...
                    case "false":
                        ...
                        listtempfrom.clear();
                        listtempTo.clear();
                        listtempfrom.add("Celsius - °C");
                        listtempfrom.add("Fahrenheit - °F");
                        listtempfrom.add("Kelvin - °K");

                        //2 spinner
                        listtempTo.add("Celsius - °C");
                        listtempTo.add("Fahrenheit - °F");
                        listtempTo.add("Kelvin - °K");
                        break;
                    ...
                    case "true":
                        ...
                        listtempfrom.add("Fahrenheit - °F");
                        listtempfrom.add("Kelvin - °K");
                        listtempfrom.add("Rankine - °R");
                        listtempfrom.add("Newton - °N");
                        listtempfrom.add("Reaumur - °Ré");
                        listtempfrom.add("Romer - °Rø");
                        listtempfrom.add("Delisle - °D");

                        //second spinner
                        listtempTo.add("Celsius - °C");
                        listtempTo.add("Fahrenheit - °F");
                        listtempTo.add("Kelvin - °K");
                        listtempTo.add("Rankine - °R");
                        listtempTo.add("Newton - °N");
                        listtempTo.add("Reaumur - °Ré");
                        listtempTo.add("Romer - °Rø");
                        listtempTo.add("Delisle - °D");

                        break;
                }
                // Creating adapter for spinner
                ArrayAdapter<String> Adapter2 = new ArrayAdapter<String>(TempertureActivity.this, android.R.layout.simple_spinner_item, listtempfrom);
                ArrayAdapter<String> AdapterTempTo2 = new ArrayAdapter<String>(TempertureActivity.this, android.R.layout.simple_spinner_item, listtempTo);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_list_fullreport:
                doubleEdittextvalue = Double.parseDouble(editTextValue.getText().toString().trim());
                Intent i = new Intent(this, ConversionTempListActivity.class);
...
protected void onResume(){
    ...
    public void calcualteValue(String strSpinnerFromvalue1, String strSpinnerTovalue2, double doubleEdittextvalue1) {
        ...
        try {
            ...
            TemperatureConverter c = new TemperatureConverter(strSpinnerFromvalue1, doubleEdittextvalue1);
    ...
    private void conversion(String strSpinnerTovalue2) {
        ...
        switch (strSpinnerTovalue2) {
            case "Celsius - °C":
                editTextValueTo.setText(str1);
                break;
            case "Fahrenheit - °F":
                editTextValueTo.setText(str2);
                break;
            case "Kelvin - °K":
                editTextValueTo.setText(str3);
                break;
            case "Rankine - °R":
                editTextValueTo.setText(str4);
                break;
            case "Newton - °N":
                editTextValueTo.setText(str5);
                break;
            case "Reaumur - °Ré":
                editTextValueTo.setText(str6);
                break;
            case "Romer - °Rø":
                editTextValueTo.setText(str7);
                break;
            case "Delisle - °D":
                editTextValueTo.setText(str8);
                break;
        }
   ...
   /* @Override
    protected void onRestart() {
        ...
        editTextValue.setText(String.valueOf(editextvalue));
        formatsetting();
