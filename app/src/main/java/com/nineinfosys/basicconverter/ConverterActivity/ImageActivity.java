...
import com.nineinfosys.basicconverter.ConverterActivityList.ConversionImageListActivity;
import com.nineinfosys.basicconverter.Engin.Image;
...
public class ImageActivity extends AppCompatActivity implements View.OnClickListener,TextWatcher {
   ...
   private Image.ConversionResults item;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(ImageActivity.this, getString(R.string.ads_app_id));
